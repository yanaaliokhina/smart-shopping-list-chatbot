...
export const TELEGRAM_BOT_DELETE_ITEMS_MENU_ITEM = "🗑️ Delete items";

export const TELEGRAM_BOT_MAIN_MENU = {
  reply_markup: {
    keyboard: [
      [TELEGRAM_BOT_VIEW_LIST_MENU_ITEM, TELEGRAM_BOT_ADD_ITEMS_MENU_ITEM],
      [TELEGRAM_BOT_CANCEL_MARK_ITEMS_BOUGHT_MENU_ITEM,TELEGRAM_BOT_DELETE_ITEMS_MENU_ITEM],
    ],
